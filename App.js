...
export default function App() {
  ...
  function handleSubmit(){
    ...
    if (imc <= 0 || alt <= 0 || peso <= 0) {
      ...
      Speech.speak('Cálculo de I M CÊ - Resultado' + `I M C = ${imc.toFixed(2)} \nVocê está MUITO ABAIXO do peso!`);
      ...
      Speech.speak('Cálculo do I M CÊ - Resultado' + `I M C = ${imc.toFixed(2)} \nVocê está com SOBREPES0!`, {language: 'pt-BR'});
      Alert.alert('Cálculo IMC - Resultado',`IMC = ${imc.toFixed(2)} \nVocê está com SOBREPESO!`);
    } else if (imc >= 30 && imc < 35) {
      Speech.speak('Cálculo do I M CÊ - Resultado' + `I M C = ${imc.toFixed(2)} \nVocê está OBESO (Ou seja, obesidade grau I)!`);
    } else if (imc >= 35 && imc < 40) {
      Speech.speak('Cálculo do I M CÊ - Resultado' + `I M C = ${imc.toFixed(2)} \nVocê está com OBESIDADE SE4ERA (Ou seja, obesidade grau II)!`, {language: 'pt-BR'});
      Alert.alert('Cálculo IMC - Resultado',`IMC = ${imc.toFixed(2)} \nVocê está com OBESIDADE SEVERA (Ou seja, obesidade grau II)!`);
    } else if (imc >= 40) {
      Speech.speak('Cálculo do I M CÊ - Resultado' + `I M C = ${imc.toFixed(2)} \nVocê está com OBESIDADE SÓRBIDA (Ou seja, obesidade grau III)!`, {language: 'pt-BR'});
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar style="light" backgroundColor="#AD62000" />
      <View>
        <CustomImage
          fromWeb={false}
          image={balanca}
